class Solution:
    def isAnagram(self, s: str, t: str) -> bool:
        ...
        for i in range(len(s)):
            main[ord(s[i]) - ord("a")] += 1
            main[ord(t[i]) - ord("a")] -= 1
        ...
        # for i in range(len(s)):
        #     # Ord would go up to 25 max so having a fixed array of 26 works here
        #     # Increase for s in count, decrease for t
        #     # it should be 0 for all values if they are anagrams
