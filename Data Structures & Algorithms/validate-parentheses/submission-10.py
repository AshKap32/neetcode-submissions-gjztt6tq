    ...
    def isValid(self, s: str) -> bool:
        ...
        for bracket in s:
            ...
            if bracket in key:
                ...
                # Checks for order here as well as right type of bracket, also check to see if there is something
                # in the stack, becuase if there is now that means we have an extra closing bracket and no opening 
                # to match that.
